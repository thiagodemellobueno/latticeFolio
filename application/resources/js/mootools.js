...
web build:
 - http://mootools.net/core/587232a61d263844af618a2f39d6b445

packager build:
 - packager build Core/Core Core/Element.Dimensions Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions Core/Request.JSON Core/JSON Core/DOMReady
...
}else{if(d>95&&d<106){this.key=d-96;}}}if(this.key==null){this.key=String.fromCharCode(d).toLowerCase();}}else{if(i=="click"||i=="dblclick"||i=="contextmenu"||i.indexOf("mouse")==0){var j=g.document;
...
},condition:function(b){return !!(this.type!="radio"||this.checked);}};}})();(function(i,k){var l,f,e=[],c,b,d=k.createElement("div");var g=function(){clearTimeout(b);
if(l){return;}Browser.loaded=l=true;k.removeListener("DOMContentLoaded",g).removeListener("readystatechange",a);k.fireEvent("domready");i.fireEvent("domready");
};var a=function(){for(var m=e.length;m--;){if(e[m]()){g();return true;}}return false;};var j=function(){clearTimeout(b);if(!a()){b=setTimeout(j,10);}};
...
// MooTools: the javascript framework.
// Load this file's selection again by visiting: http://mootools.net/more/08a691bfc70d42453a1edcbb2e914c21 
// Or build this file again with packager using: packager build More/Fx.Scroll More/Assets More/Spinner
/*
---
copyrights:
  - [MooTools](http://mootools.net)
